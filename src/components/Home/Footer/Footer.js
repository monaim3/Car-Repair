    ...
    return (
      ...
      <div className="container">
          ...
          <div className="row">
              ...
              <div className="footer-box col-md-3 col-sm-6">
                  ...
                  <div className="contact-icon d-flex align-items-center mb-4">
                      ...
                      <span>Colony, Bogura, Bangladesh</span>
                  </div>

                  <div className="contact-icon d-flex align-items-center mb-4">
                      <FontAwesomeIcon icon={faPhone} />
                      <span> +880 1783850584 <br /> +880 1644793299</span>
                  </div>

                  <div className="contact-icon d-flex align-items-center mb-4">
                      <FontAwesomeIcon icon={faEnvelope} />
                      <span> monaimmukul75@gmail.com <br /> monaimmukul240@gmail.com</span>
                  </div>
              ...
              <div className="footer-box col-md-3 col-sm-6">
                  ...
                  <div className="fRpost">
                      ...
                      <div className="fRpostTitle">
                          ...
                          <p><FontAwesomeIcon icon={faUser} />By Owner </p>
                          <p><FontAwesomeIcon icon={faComments} />25</p>
                      </div>
          ...
          <div className="copy-right-container">
              <p>Copyright &copy; {new Date().getFullYear()}, All rights reserved Car-Repair </p>
          </div>
